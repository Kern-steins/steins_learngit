...
double (*real_part_tb1[])(const complex_struct) =
{ rect_real_part, pol_real_part };
double (*img_part_tb1[])(const complex_struct) =
{ rect_img_part, pol_img_part };
double (*magnitude_tb1[])(const complex_struct) =
{ rect_magnitude, pol_img_part };
double (*angle_tb1[])(const complex_struct) =
{ rect_angle, pol_magnitude };
